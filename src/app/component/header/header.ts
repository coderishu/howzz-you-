...
trending()
{
  let URL = appConstant.baseUrl+'front/filter/category_product_view';
  let data = { "lang_id":appConstant['defaultLangId'],"lang":appConstant['defaultLang']}
  this.httpService.createPostRequest(URL,data).subscribe((response: any) => {
   this.trendingArray=response['data'];
    });
}
